...
public class ContainerIOUsage {
    ...
    public static final String ATTRIBUTE_SERVICEREQUESTS_NAME = "serviceRequests";
    public static final String ATTRIBUTE_SERVICEREQUESTS_TYPE = "long";
    public static final String ATTRIBUTE_DATATRANSFERRED_NAME = "dataTransferred";
    public static final String ATTRIBUTE_DATATRANSFERRED_TYPE = "long";
}
