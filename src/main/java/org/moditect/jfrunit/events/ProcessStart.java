...
public class ProcessStart {
    ...
    public static final String ATTRIBUTE_DIRECTORY_NAME = "directory";
    public static final String ATTRIBUTE_DIRECTORY_TYPE = "String";
    public static final String ATTRIBUTE_COMMAND_NAME = "command";
    public static final String ATTRIBUTE_COMMAND_TYPE = "String";
}
